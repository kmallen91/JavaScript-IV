  ...
  // Test you work by un-commenting these 3 objects and the list of console logs below:
    ...
    class Hero extends Humanoid{
      ...
      this.holyName = heroic.holyName;
        ...
        HolyBlast(evilName){return `${evilName.name} is hit by Holy Blast, ${evilName.name} has ${evilName.healthPoints -10} HP!` }
    };
    ...
    class Villain extends Humanoid{
      ...
      this.evilName = evil.evilName;
        ...
        Strangle(holyName){return `${holyName.name} is being Strangled, ${holyName.name} has ${holyName.healthPoints-10} HP!` }
}
